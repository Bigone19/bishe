...
lines = 237914  # 根据train_log_iou.txt的行数修改
result = pd.read_csv('training_iou.log', skiprows=[x for x in range(lines) if (x % 10 == 0 or x % 10 == 9)],
                     error_bad_lines=False, names=['Class', 'Obj', 'No Obj', 'count'])
result.head()
